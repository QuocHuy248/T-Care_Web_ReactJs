    ...
    useEffect(() => {
        ...
        client.connect({}, () => {
            client.subscribe("/topic/saler", (message) => {
                ...
                toast.success("Hợp đồng của bạn vừa được tạo");
            });
        });
    ...
    const contractDetail = (
        <>
            <div style={{ textAlign: "center" }}>
                ...
                ></div>
                <div style={{ textAlign: "right", marginRight: "22px", marginBottom: "20px" }}>
                    {date}
                </div>
            ...
            <div style={{ padding: "30px" }}>
                ...
                <span>
                    {" "}
                    <td>
                        {contract?.user !== null ? contract?.user.name : contract?.customerName}{" "}
                    </td>
                    .
                </span>{" "}
                <br />
                ...
                <span style={{ fontWeight: "600" }}>2.</span> <span> Thời gian làm việc: </span>{" "}
                <br />
                <span>
                    <div className="row">
                        <div className="col-6">
                ...
                <div style={{ padding: "20px 16%" }}>
                    <span style={{ fontSize: "13px" }}>
                        ( Điều khoản được in vào ở hợp đồng bằng văn bản được bên A và bên B cất
                        giữ)
                    </span>
                </div>
                <div style={{ textAlign: "center" }}>
